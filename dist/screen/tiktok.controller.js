...
const post_tiktok_dto_1 = require("./dto/post-tiktok.dto");
let TikTokController = class TikTokController {
    constructor(tiktokService) {
        this.tiktokService = tiktokService;
    }
    async postToTikTok(postTikTokDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [post_tiktok_dto_1.PostTikTokDto]),
    __metadata("design:returntype", Promise)
], TikTokController.prototype, "postToTikTok", null);
